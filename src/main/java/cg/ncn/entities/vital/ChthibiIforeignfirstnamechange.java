...
/**
 * ChthibiIforeignfirstnamechange generated by hbm2java
 */
@Entity
@Table( name = "chthibi_iforeignfirstnamechange", catalog = "vitalstatistics" )
public class ChthibiIforeignfirstnamechange implements java.io.Serializable {
    ...
    public ChthibiIforeignfirstnamechange() {
    }

    public ChthibiIforeignfirstnamechange( int idbirth, int idtype, String newfr, String oldfr, String act,
