...
/**
 * ChthibiIdeathforeignfirstnamechange generated by hbm2java
 */
@Entity
@Table( name = "chthibi_ideathforeignfirstnamechange", catalog = "vitalstatistics" )
public class ChthibiIdeathforeignfirstnamechange implements java.io.Serializable {
    ...
    public ChthibiIdeathforeignfirstnamechange() {
    }

    public ChthibiIdeathforeignfirstnamechange( int iddeath, int idtype, String newfr, String oldfr, String act,
            String newar, String oldar, int daygeorgian, int monthgeorgian, int yeargeorgian, int dayhijri,
            int monthhijri, int yearhijri, int daygeorgianedition, int monthgeorgianedition, int yeargeorgianedition,
    ...
    public ChthibiIdeathforeignfirstnamechange( int iddeath, int idtype, String newfr, String oldfr, String act,
            String newar, String oldar, Date date, int daygeorgian, int monthgeorgian, int yeargeorgian, int dayhijri,
            int monthhijri, int yearhijri, int daygeorgianedition, int monthgeorgianedition, int yeargeorgianedition,
            int dayhijriedition, int monthhijriedition, int yearhijriedition, int iduser, int valid,
