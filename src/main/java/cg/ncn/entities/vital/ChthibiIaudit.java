...
/**
 * ChthibiIaudit generated by hbm2java
 */
@Entity
@Table( name = "chthibi_iaudit", catalog = "vitalstatistics" )
public class ChthibiIaudit implements java.io.Serializable {
    ...
    public ChthibiIaudit() {
    }

    public ChthibiIaudit( int idbirth, int idtype, String who, String with, String act, String court, int daygeorgian,
    ...
    public ChthibiIaudit( int idbirth, int idtype, String who, String with, String act, String court, Date date,
            ...
            String courtfr, String mentionofficerar, String mentionofficerfr ) {
        this.idbirth = idbirth;
        this.idtype = idtype;
        this.who = who;
        this.with = with;
