...
/**
 * ChthibiIdeathsinbirthplace generated by hbm2java
 */
@Entity
@Table( name = "chthibi_ideathsinbirthplace", catalog = "vitalstatistics" )
public class ChthibiIdeathsinbirthplace implements java.io.Serializable {
    ...
    public ChthibiIdeathsinbirthplace() {
    }

    public ChthibiIdeathsinbirthplace( int idbirth, int idtype, String who, String city, int daygeorgian,
    ...
    public ChthibiIdeathsinbirthplace( int idbirth, int idtype, String who, String city, String act, Integer year,
            ...
            String cityfr, String mentionofficerar, String mentionofficerfr ) {
        this.idbirth = idbirth;
        this.idtype = idtype;
        this.who = who;
        this.city = city;
