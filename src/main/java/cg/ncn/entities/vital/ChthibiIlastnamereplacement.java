...
/**
 * ChthibiIlastnamereplacement generated by hbm2java
 */
@Entity
@Table( name = "chthibi_ilastnamereplacement", catalog = "vitalstatistics" )
public class ChthibiIlastnamereplacement implements java.io.Serializable {
    ...
    public ChthibiIlastnamereplacement() {
    }

    public ChthibiIlastnamereplacement( int idbirth, int idtype, String newfr, String oldfr, String act, String newar,
            String oldar, int daygeorgian, int monthgeorgian, int yeargeorgian, int dayhijri, int monthhijri,
    ...
    public ChthibiIlastnamereplacement( int idbirth, int idtype, String newfr, String oldfr, String act, String newar,
            String oldar, Date date, int daygeorgian, int monthgeorgian, int yeargeorgian, int dayhijri, int monthhijri,
            int yearhijri, int daygeorgianedition, int monthgeorgianedition, int yeargeorgianedition,
            int dayhijriedition, int monthhijriedition, int yearhijriedition, int iduser, int valid,
