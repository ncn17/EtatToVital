...
/**
 * ChthibiIdeathacquiremoroccannationality generated by hbm2java
 */
@Entity
@Table( name = "chthibi_ideathacquiremoroccannationality", catalog = "vitalstatistics" )
public class ChthibiIdeathacquiremoroccannationality implements java.io.Serializable {
    ...
    public ChthibiIdeathacquiremoroccannationality() {
    }

    public ChthibiIdeathacquiremoroccannationality( int iddeath, int idtype, String under, String act, String by,
    ...
    public ChthibiIdeathacquiremoroccannationality( int iddeath, int idtype, String under, String act, String by,
            ...
            int dayhijriedition, int monthhijriedition, int yearhijriedition, int iduser, int valid, String underfr,
            String byfr, String mentionofficerar, String mentionofficerfr ) {
        this.iddeath = iddeath;
        this.idtype = idtype;
        this.under = under;
        this.act = act;
