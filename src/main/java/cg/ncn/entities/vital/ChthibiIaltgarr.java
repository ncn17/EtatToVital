...
/**
 * ChthibiIaltgarr generated by hbm2java
 */
@Entity
@Table( name = "chthibi_ialtgarr", catalog = "vitalstatistics" )
public class ChthibiIaltgarr implements java.io.Serializable {
    ...
    public ChthibiIaltgarr() {
    }

    public ChthibiIaltgarr( int idbirth, int idtype, String who, String with, String act, String court,
    ...
    public ChthibiIaltgarr( int idbirth, int idtype, String who, String with, String act, String court, Date date,
            int daygeorgianedition, int monthgeorgianedition, int yeargeorgianedition, int dayhijriedition,
