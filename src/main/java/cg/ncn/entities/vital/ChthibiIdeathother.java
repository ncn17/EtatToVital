...
/**
 * ChthibiIdeathother generated by hbm2java
 */
@Entity
@Table( name = "chthibi_ideathother", catalog = "vitalstatistics" )
public class ChthibiIdeathother implements java.io.Serializable {
    ...
    public ChthibiIdeathother() {
    }

    public ChthibiIdeathother( int iddeath, int idtype, String content, int daygeorgianedition,
    ...
    public ChthibiIdeathother( int iddeath, int idtype, String content, int daygeorgianedition,
            int monthgeorgianedition, int yeargeorgianedition, int dayhijriedition, int monthhijriedition,
            int yearhijriedition, int iduser, int valid, String contentfr, String mentionofficerar,
