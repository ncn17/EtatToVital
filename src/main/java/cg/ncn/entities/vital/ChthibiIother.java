...
/**
 * ChthibiIother generated by hbm2java
 */
@Entity
@Table( name = "chthibi_iother", catalog = "vitalstatistics" )
public class ChthibiIother implements java.io.Serializable {
    ...
    public ChthibiIother() {
    }

    public ChthibiIother( int idbirth, int idtype, String content, int daygeorgianedition, int monthgeorgianedition,
