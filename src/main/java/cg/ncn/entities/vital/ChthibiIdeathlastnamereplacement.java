...
/**
 * ChthibiIdeathlastnamereplacement generated by hbm2java
 */
@Entity
@Table( name = "chthibi_ideathlastnamereplacement", catalog = "vitalstatistics" )
public class ChthibiIdeathlastnamereplacement implements java.io.Serializable {
    ...
    public ChthibiIdeathlastnamereplacement() {
    }

    public ChthibiIdeathlastnamereplacement( int iddeath, int idtype, String newfr, String oldfr, String act,
    ...
    @Column( name = "NEWAR", nullable = false, length = 45 )
    ...
    @Column( name = "OLDAR", nullable = false, length = 45 )
