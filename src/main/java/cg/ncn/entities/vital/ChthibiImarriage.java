...
/**
 * ChthibiImarriage generated by hbm2java
 */
@Entity
@Table( name = "chthibi_imarriage", catalog = "vitalstatistics" )
public class ChthibiImarriage implements java.io.Serializable {
    ...
    private String  sentfromfr;
    private String  courtfr;
    private String  mentionofficerar;
    private String  mentionofficerfr;

    public ChthibiImarriage() {
    }

    public ChthibiImarriage( int idbirth, int idtype, String who, String with, String act, String court,
            ...
            int monthhijriedition, int yearhijriedition, int iduser, int valid, int issent ) {
    ...
    public ChthibiImarriage( int idbirth, int idtype, String who, String with, String act, String court, Date date,
            int daygeorgian, int monthgeorgian, int yeargeorgian, int dayhijri, int monthhijri, int yearhijri,
            int daygeorgianedition, int monthgeorgianedition, int yeargeorgianedition, int dayhijriedition,
            int monthhijriedition, int yearhijriedition, int iduser, int valid, String page, String cahier, int issent,
            String sentfrom, String whofr, String withfr, String sentfromfr, String courtfr, String mentionofficerar,
    ...
    @Column( name = "SENTFROM", length = 128 )
    ...
    @Column( name = "SENTFROMFR", length = 128 )
    public String getSentfromfr() {
        return this.sentfromfr;
    }

    public void setSentfromfr( String sentfromfr ) {
        this.sentfromfr = sentfromfr;
    }
