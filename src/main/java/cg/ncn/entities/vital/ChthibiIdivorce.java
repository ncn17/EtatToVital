...
/**
 * ChthibiIdivorce generated by hbm2java
 */
@Entity
@Table( name = "chthibi_idivorce", catalog = "vitalstatistics" )
public class ChthibiIdivorce implements java.io.Serializable {
    ...
    public ChthibiIdivorce() {
    }

    public ChthibiIdivorce( int idbirth, int idtype, String who, String with, String act, String court, int daygeorgian,
            ...
            int yearhijriedition, int iduser, int valid, int judgementtype ) {
    ...
    public ChthibiIdivorce( int idbirth, int idtype, String who, String with, String act, String court, Date date,
            ...
            String courtfr, String mentionofficerar, String mentionofficerfr, String page, String cahier,
            int judgementtype ) {
        this.idbirth = idbirth;
        this.idtype = idtype;
        this.who = who;
    ...
    @Column( name = "JUDGEMENTTYPE", nullable = false )
